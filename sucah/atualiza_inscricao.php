...
$pasta = "assets/images/aluno/";
$cadastrar = 0;
$select = mysqli_query($link, "SELECT codAluno, nomeAluno FROM tb_inscricao") or die(mysqli_error($link));
while ($linha = mysqli_fetch_array($select)){
	if($linha['codAluno'] == $codAluno){
		$cadastrar = 1;
		echo "Aluno pronto para ser atualizado.<br><br>";
	}
}
