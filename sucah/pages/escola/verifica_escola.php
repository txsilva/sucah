            ...
            <div class="page-wrapper">
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  $pasta = "/sucah/pages/escola/fotos";
                  $foto_tmp = $_FILES['foto']['tmp_name'];
                  $foto_real = $_FILES['foto']['name'];
                  $data = date('H:i:s');
                  copy($foto_tmp,"/sucah/pages/escola/fotos/$foto_real");
                  $cre = $_POST['cre'];
                  $telefone_sala = $_POST['devolutiva'];
                 ...
                 if($cadastrar == 0){
                   $sql = mysqli_query($link, "INSERT INTO tb_escola SET nomeEscola='$nomeEscola', foto='$foto_real', cre='$cre', telefone='$telefone_sala', latitude='$latitude', longitude='$longitude', descricao='$descricao'")  or die (mysqli_error($link));
                 }else{
                   echo "A sala de recurso foi cadastrada anteriormente, contate o administrador do sistema.<br><br>Aguarde o formulário ser recarregado.";
                   echo '<meta http-equiv="refresh" content="10;url=escola.html">';
                 }
