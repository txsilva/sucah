...
<?php
			...
			$count_professor = 0;
				...
				$_SESSION['privilegio'] = $linha['privilagio'];
			     }
                        }
?>
    <!-- ============================================================== -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <div class="text-center m-t-30">
                        <a href="https://themewagon.com/themes/bootstrap-4-responsive-admin-template/" class="btn waves-effect waves-light btn-warning hidden-md-down">Gerar relatório</a>
                    </div>
                </nav>
...
?>
			...
			?>
                            <div class="card-block little-profile text-center">
                                ...
                                <p><?php echo "$cre"; ?></p>
			        <a href="/sucah/pages/relatorio/relatorio.php" class="m-t-10 waves-effect waves-dark btn btn-primary btn-md " onclick="relatorio();">Relatório da unidade</a>
...
?></h3><small>Atendimentos<br><i class="mdi mdi-format-float-none"></i></small></div>
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
							...
							<span class="mdi mdi-numeric-3-box-multiple-outline"></span><a href="pages/atendimento/atendimento.php"><button class="btn btn-success" style="width:100%; height:3rem;"><b>DEMANDA REPRIMIDA <i class="mdi mdi-format-list-numbers"></i></b></button></a>                             
							<span class="mdi mdi-numeric-4-box-multiple-outline"></span><a href="pages/atendimento/atendimento_realizado.php"><button class="btn btn-info" style="width:100%; height:3rem;"><b>ATEND. REALIZADOS <i class="mdi mdi-content-duplicate"></i></b></button></a> 
                                                </div>
                                </div>
                            </div>
                        </div>
